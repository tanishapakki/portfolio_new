...
export const AnimatedSpan = ({
  ...
  return (
    <motion.div
      ...
      className={cn("text-sm font-normal tracking-tight text-gray-800", className)}
      onAnimationComplete={() => {
        if (!sequence) return
...
export const TypingAnimation = ({
  ...
  return (
    <MotionComponent
      ref={elementRef}
      className={cn("grid text-sm font-normal tracking-tight text-gray-800", className)}
      {...props}
    >
      {displayedText}
    </MotionComponent>
...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
     className={cn(
  "bg-white border-gray-200 text-gray-800 z-0 h-full w-full rounded-xl border  shadow-md",
  className
)}
    >
      <div className="border-b border-gray-200 mb-1 h-7 flex items-center p-3"
>
        <div className="flex flex-row gap-1.5 w-10 ">
